...
const categories = [
  ...
  { slug: "spices", title: "Spices & Masala", group: "Culture", description: "Spices, herbs, aromatics, seeds, and masala blends used in Bangladesh.", filters: ["category", "is_blend"], sample: { id: 1, name_en: "Turmeric", name_bn: "হলুদ", category: "ground_spice", form: ["whole rhizome", "powder"], is_blend: false } },
...
const filterDescriptions: Record<string, string> = {
  ...
  is_blend: "Use true for masala blends and false for single spices or herbs.",
